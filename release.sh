...
}
{
    ...
    print best_match
}' "./cnacc_data.tmp" | sort | uniq > "./lite_cnacc_data_new.tmp"
...
}
{
    ...
    print best_match
}' "./gfwlist_data.tmp" | sort | uniq > "./lite_gfwlist_data_new.tmp"

    lite_cnacc_data=($(cat "./lite_cnacc_data_new.tmp" | awk "{ print $2 }"))
    lite_gfwlist_data=($(cat "./lite_gfwlist_data_new.tmp" | awk "{ print $2 }"))
}
# Generate Rules
